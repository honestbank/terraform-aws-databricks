...
# In order to ensure role is created before attempting to create the workspace
# we add a timeout of 30 seconds.
...
resource "databricks_mws_workspaces" "workspace" {
  ...
  workspace_name  = "${var.prefix}-${var.workspace_name}"
  ...
  token {
    comment = "Created by honestbank/terraform-aws-databricks"
  }
}
